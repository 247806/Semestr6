...
W niniejszej sekcji przedstawiono wstępne wyniki klasyfikacji uzyskane dla ograniczonego zbioru tekstów testowych zawierającego 1277 artykułów. Celem analizy było zbadanie wpływu wybranych parametrów wejściowych na skuteczność klasyfikatora, mierzonych za pomocą miary Accuracy. 
...
\begin{table}[h!]
    ...
    1 & Metryka euklidesowa & 0.8904\\ \hline
    2 & Metryka uliczna & 0.8845 \\ \hline
    3 & Metryka Czybyszewa & - \\ \hline
    \end{tabular}
    \caption{Wyniki miary Accuracy dla różnego podziału zbiorów}
\end{table}
...
Wyniki wskazują na najlepszą skuteczność klasyfikatora przy zastosowaniu metryki euklidesowej, uzyskując miarę Accuracy równą 0{,}8904. Metryka uliczna, choć również dała zadowalające wyniki (Accuracy = 0{,}8845), okazała się nieco mniej efektywna w porównaniu do metryki euklidesowej. Z kolei metryka Czybyszewa, mimo że została uwzględniona w eksperymencie, nie została jeszcze zaimplementowana, stąd brak wyników dla tej metryki.
